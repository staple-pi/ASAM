...
from asam_utils import init_distributed_mode, train_one_epoch, weights_init, SAM_o, ASAM, SA1BDataset, cleanup, train_one_epoch_wg
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        mean_loss = train_one_epoch_wg(asam, sam_o,train_dataloader, epoch, optimizer,device, args.batch_size)
        scheduler.step()
        if rank == 0:
