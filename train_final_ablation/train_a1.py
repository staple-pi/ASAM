...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        mean_loss = train_ablation1(asam, d_model,train_dataloader, epoch, optimizer, optimizer_d, device, args.batch_size, tb_writer)
        scheduler.step()
        scheduler2.step()
        if rank == 0:
            ...
            weight_name ="ablation1-{}.pth".format(num_epoch)
            d_weight_name ="discriminator-ablation1-{}.pth".format(num_epoch)
